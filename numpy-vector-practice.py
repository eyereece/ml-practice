...
# NumPy routines which allocate memory and fill arrays with value but not accept shape as input argument
...
# access 5 consecutibe elements (start:stop:step)
...
# access all elements
print("a[:,:] = \n", a[1,:], ", a[1,:].shape =", a[1,:].shape, "a 1-D array")
# same as
